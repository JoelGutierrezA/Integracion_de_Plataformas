...
public class UsuarioController {
    ...
    @Autowired
    private IUsuario usuarioService; // Inyección de dependencia del servicio de cliente
    ...
    public Usuario create(@RequestBody Usuario usuario){
        return usuarioService.save(usuario); // Guarda un nuevo cliente y retorna el cliente creado
    }
    ...
    public Usuario update(@RequestBody Usuario usuario){
        return usuarioService.save(usuario); // Actualiza un cliente existente y retorna el cliente actualizado
    }
    ...
    public Usuario showById(@PathVariable Integer id){
        return usuarioService.findById(id); // Retorna un cliente específico por su ID con el código de estado HTTP 200 (OK)
    }

    // Maneja solicitudes GET a la URL "/api/v1/clientes"
    @GetMapping("usuarios")
    @ResponseStatus(HttpStatus.OK)
    public @ResponseBody ArrayList<Usuario> showAll(){
        return usuarioService.findByAll(); // Retorna todos los clientes con el código de estado HTTP 200 (OK)
    }
